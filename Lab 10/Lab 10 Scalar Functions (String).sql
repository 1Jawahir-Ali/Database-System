-- LAB 10
-- SCALAR FUNCTIONS PART 01: STRING FUNCTIONS
...
-- Q1
SELECT EmpID, FullName AS OriginalFullName, UPPER(TRIM(FullName)) AS CleanedName
FROM Employee;
...
-- Q4
SELECT FullName,
       CONCAT(REPLACE(LOWER(TRIM(FullName)), ' ', '.'), '@company.com') AS GeneratedEmail
FROM Employee;
